...
const SingleRecipe = () => {
    ...
    return (
        <div className="w-full min-h-screen6060zdsfgvadfscdsfgsdsdf flex flex-col lg:flex-row gap-4 p-6 bg-teal- text-black">
            {/* Left: Recipe Preview */}
            <div className="relative lg:w-1/2 w-full bg-teal-700 p-6 rounded-3xl shadow-lg  animate-fade-in">
                ...
                <h1 className="text-5xl font-extrabold text-amber-200 mb-4">{recipe.title}</h1>
                <img
                    className="w-full h-64 object-cover rounded-xl shadow-md mb-4 border-2 border-white"
                    src={recipe.image}
                    alt={recipe.title}
                />
                <h2 className="text-3xl text-amber-300 font-semibold mb-2">{recipe.chef}</h2>
            ...
            <div className="lg:w-1/2 w-full bg-teal-700 p-6 rounded-3xl shadow-lg  animate-slide-in">
                ...
                <form onSubmit={handleSubmit(UpdateHandler)} className="flex flex-col gap-4">
                    <input
